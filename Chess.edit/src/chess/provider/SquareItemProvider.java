...
/**
 * This is the item provider adapter for a {@link chess.Square} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SquareItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ChessPackage.Literals.SQUARE__FILE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ChessPackage.Literals.SQUARE__RANK,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ChessPackage.Literals.SQUARE__COLOR,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addPiecePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Square_piece_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Square_piece_feature", "_UI_Square_type"),
				 ChessPackage.Literals.SQUARE__PIECE,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((Square)object).getFile();
