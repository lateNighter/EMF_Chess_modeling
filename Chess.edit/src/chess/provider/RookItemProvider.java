...
/**
 * This is the item provider adapter for a {@link chess.Rook} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RookItemProvider extends PieceItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Rook_hasMoved_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Rook_hasMoved_feature", "_UI_Rook_type"),
				 ChessPackage.Literals.ROOK__HAS_MOVED,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		PlayerColor labelValue = ((Rook)object).getColor();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_Rook_type") :
